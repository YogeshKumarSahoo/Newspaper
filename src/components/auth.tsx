    ...
    return (
        <div className="flex justify-center items-center h-screen bg-slate-100">
            <div className="max-w-md w-full">
                ...
                <div className="mt-10">
                    { type === "signup" ? (laballedInput({lable: "Username",placeholder: "Enter your username",onChange: (e) => {
                        setPostInput({
                                ...postinput,
                                name: e.target.value
                            })
                    ...
                    {/* <button onClick={sendRequest} className="mt-3 bg-black text-white text-xl w-full rounded p-2">
                        {type === "signup" ? "Sign up" : "Sign in"}
                    </button> */}

                    
                    <button type="button" onClick={sendRequest} className="mt-3 bg-black text-white text-xl w-full rounded p-2">
